...
On the other hand,  SC requires that the precedence order among operations from each client in the system must be preserved in a  valid total order $\preccurlyeq$ in a valid partial order enumeration $\Pi(\mathcal{S}_t,E^s) $,  comprising operations from all clients. Similarly, TSO 
