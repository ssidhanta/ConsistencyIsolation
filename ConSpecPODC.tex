...
In this section, we present the ConSpec specifications for several common consistency models  documented in the literature~\cite{Chockler2000, Terry:1994:SGW:645792.668302, Burckhardt:2014:PEC:2693641.2693642}. We make the derivations of  ConSpec definitions from their original counterparts in an extended version of the paper available at \url{https://github.com/ssidhanta/ConSpecTool}. %Subsequently, in the Appendix, we discuss how these definitions correspond to their original counterparts.
