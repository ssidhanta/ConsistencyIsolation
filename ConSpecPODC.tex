...
\begin{document}
\title{A Generalized Model of Consistency and Isolation Levels}
...
\section{Introduction}
   ...
   guarantees.  Currently, there is a large number of possible consistency models and isolation levels, many of which are not
