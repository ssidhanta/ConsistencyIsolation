...
\forall x, y, \mathit{st}, \mathit{st}^{'} \in \mathit{St}  \left( {\mathit{Op}}^{'}(x) F {\mathit{Op}}^{''} (y) \in \mathit{st} \right) \rightarrow  \left(  \left( {\mathit{Op}}^{'}(x) \preccurlyeq_{st} {\mathit{Op}}^{''} (y)   \right) \wedge  \left( {\mathit{Op}}^{'}(x)  \preccurlyeq_{{st}^{'}}  {\mathit{Op}}^{''} (y)  \right) \right),
\end{split}
  \end{align}
