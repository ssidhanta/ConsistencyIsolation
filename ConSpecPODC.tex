...
% \mathit{st} \in \mathcal{S}_t,
 E^{s} = \forall \;  {R}', {R}'' \in \mathit{st} : \; {R}' \operatorname{\it F}_\mathit{st} {R}''
...
E^{s} =  \forall \; {R}', {W}' \in \mathit{st} : \; {R}^{'} \operatorname{\it F}_\mathit{st} {W}'
...
E^{s} = \forall \; {W}', {W}'' \in \mathit{st} : \; {W}' \operatorname{\it F}_\mathit{st} {W}''  \Rightarrow {W}' \preccurlyeq_{\mathit{st}+w} {W}'' , %; \\
