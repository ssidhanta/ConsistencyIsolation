...
% $\mathit{o}^2$, respectively.
  \par Using the above notations, Chockler et al. states the RYW consistency model as follows.  For any pair of read and write operations $\mathit{o}^1$ and $\mathit{o}^2$ comprised in a given execution $\sigma_i$ for a process $p_i$, if the condition  (let us call this Condition 1) 
   ...
   operations invoked by $p_i$ plus writes invoked by other clients, for which the condition (let us call this Condition 2) 
