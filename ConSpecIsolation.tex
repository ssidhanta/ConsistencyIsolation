...
\begin{split}
 E^{s} =  \exists x, y, \mathit{tx}, \mathit{ty} \in T, W(x,v)_{\mathit{tx}}, R(x){v^{'}}_{\mathit{ty}} \in  \mathcal{S}_t: 
...
\begin{split}
 E^{s} =  \exists x, y, \mathit{tx}^{c}, \mathit{ty} \in T, W(x,v)_{\mathit{tx}}^{c}, R(x){v^{'}}_{\mathit{ty}} \in  \mathcal{S}_t: 
...
\begin{split}
 E^{s} =  \; \exists x, y, \mathit{tx}^{c}, \mathit{ty} \in T, W(x,v)_{\mathit{tx}}^{c}, R(x){v^{'}}_{\mathit{ty}}, R_{\mathit{ty}}(x){v^{''}} \in \mathcal{S}_t: \; \exists \mathit{tx} \in T:  \\
...
%  \end{align}
  ...
  SI-b: A transaction observes complete effects of transactions that committed before it started.  SI-a can be interpreted as follows.   If a pair of transactions can observe results of each other, they are not concurrent, i.e., $\preccurlyeq$ among a pair of transactions in Definition \ref{def:form0} is a total order $\prec$.  According to SI-b the above total order must be among committed version of $\mathit{tx}$ and $\mathit{ty}$, i.e., $\mathit{tx}^{c} \prec \mathit{ty}$. The above condition reduces to: $ \exists x, y, \mathit{tx}^{c}, \mathit{ty} \in T, W(x,v)_{\mathit{tx}}^{c}, R(x){v^{'}}_{\mathit{ty}}, R_{\mathit{ty}}(x){v^{''}} \in \mathcal{S}_t:  \; \exists \mathit{tx} \in T:  
v^{'} = v^{''}  \quad \Rightarrow \quad %\mathit{ty} \not \preccurlyeq \mathit{ty} \quad \wedge \quad 
...
\begin{split}
 E^{s} =  \; \exists x, y, \mathit{tx}^{c}, \mathit{ty} \in T, W(x,v)_{\mathit{tx}}^{c}, R(x){v^{'}}_{\mathit{ty}}, R_{\mathit{ty}}(x){v^{''}} \in \mathcal{S}_t: \\ %\; \exists \mathit{tx} \in T:  \\
 v^{'} = v^{''}  \quad \Rightarrow \quad %\mathit{ty} \not \preccurlyeq \mathit{ty} \quad \wedge \quad 
 \mathit{tx}^{c} \prec \mathit{ty} \quad
...
\begin{split}
 E^{s} =  \; \forall {\mathit{tx}}^{c}, \mathit{y}^{c} \in T: \;
