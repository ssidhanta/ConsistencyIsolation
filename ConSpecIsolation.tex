...
The partial order relation $\mathit{tx} \preccurlyeq \mathit{ty}$ in Condition 2 %as $\mathit{tx} \preccurlyeq_{\mathit{wr}} \mathit{ty}$,  where the suffix ${\mathit{wr}}$ restricts the partial order $\preccurlyeq$ among write operations in $\mathit{tx}$ and read operations in $\mathit{ty}$, %which 
  %precedes the transaction $ {\mathit{tx}}$ in $\preccurlyeq$,  
  implies  $\exists W(x,v)_{\mathit{tx}}, R(x){v^{'}}_{\mathit{ty}} \in  \mathcal{S}_t: %W(x,v)_{\mathit{tx}} \operatorname{\it F}_\mathit{st} R(x){v^{'}}_{\mathit{ty}} \wedge 
 ...
 %   \mathit{ty} \preccurlyeq_{\mathit{wr}} \mathit{tz} \wedge v^{'} = v^{''}  \rightarrow \mathit{tx} \preccurlyeq_{\mathit{rw}} \mathit{ty}$.  
  ...
  %which 
  %precedes the transaction $ {\mathit{tx}}$ in $\preccurlyeq$,  
  	$\exists W(x,v)_{\mathit{tx}}, R(x){v^{'}}_{\mathit{ty}} \in  \mathcal{S}_t: %W(x,v)_{\mathit{tx}} \operatorname{\it F}_\mathit{st} R(x){v^{'}}_{\mathit{ty}} \wedge 
   v = v^{'}  \rightarrow \mathit{tx} \prec \mathit{ty}$ or $\exists W(x,v)_{\mathit{ty}}, R(x){v^{'}}_{\mathit{tx}} \in  \mathcal{S}_t: %W(x,v)_{\mathit{tx}} \operatorname{\it F}_\mathit{st} R(x){v^{'}}_{\mathit{ty}} \wedge 
...
%   \mathit{tz} \preccurlyeq_x {\mathit{ty}} \quad \wedge \quad \mathit{tx} \preccurlyeq {\mathit{tz}}.
 E^{s} = \forall \mathit{tx}, \mathit{ty} \in T. \;  \exists W(x,v)_{\mathit{tx}}, R(x){v^{'}}_{\mathit{ty}} \in  \mathcal{S}_t: 
  \mathit{tx} \preccurlyeq {\mathit{ty}} \\
   \Rightarrow  \quad \not \exists \mathit{tz} \in T, W(x,v^{''})_{\mathit{tz}}, R(x){v^{'''}}_{\mathit{tz}} \in  \mathcal{S}_t: 
...
\begin{split}
 E^{s} =  \forall \mathit{tx}, \mathit{ty} \in T, R(x){v^{'}}_{\mathit{ty}}, R_{\mathit{ty}}(x){v^{''}} \in \mathcal{S}_t. \; \exists W(x,v)_{\mathit{tx}} \in \mathcal{S}_t: \\ %\; \exists \mathit{tx} \in T:  \\
